      ...
      <Grid container justifyContent="center" spacing={2} maxWidth="100%">
        ...
        >
          ...
          <Typography variant="body2">
            ...
            discipline (for hitters) multiplied by their age percentile (younger
            is better).
          </Typography>
        </Paper>
        <Paper
        ...
        >
          ...
          <Typography variant="body2">
            ...
            expected slugging against, exit velocity against, hard hit rate, and
            barrel rate, all as a percentile stat.
          </Typography>
        </Paper>
        <Paper
          sx={{
        ...
        >
          ...
          <Typography variant="body2">
            Statcast defines a 'hard-hit ball' as one hit with an exit velocity
            of 95 mph or higher.
          </Typography>
        </Paper>
      </Grid>
